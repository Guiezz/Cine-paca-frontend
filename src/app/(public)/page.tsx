    ...
    <div className="flex flex-col items-center gap-6 w-full max-w-[1140px] mx-auto pb-14">
      ...
      <section className="flex w-full flex-col gap-4 overflow-hidden rounded-[22px] border border-cine-border bg-gradient-to-br from-[#24163D] via-[#291356] to-[#1E004E] px-10 py-14">
        <div className="flex max-w-[900px] flex-col gap-4">
          ...
          <form
            action="/obras"
            className="flex w-full max-w-[820px] items-center gap-3 pt-4"
          >
            <div className="flex flex-1 items-center gap-3 rounded-full border border-cine-50/20 bg-cine-50 px-5 py-3.5">
              <svg
                width="22"
                height="22"
                viewBox="0 0 22 22"
      ...
      <section className="flex w-full items-center gap-5 rounded-[18px] border border-cine-border bg-[rgba(42,26,69,0.82)] px-4 py-4">
        <span className="font-mono text-[11px] font-[400] uppercase tracking-[0.08em] text-cine-yellow-light">
          FILTROS DE AULA
        </span>
      ...
      <section className="flex w-full gap-7">
        ...
        <div className="flex flex-1 flex-col gap-[18px]">
          ...
          <div className="grid grid-cols-[1.18fr_1fr_1fr] grid-rows-2 gap-4">
            {featured ? (
              ...
              <div className="col-span-1 row-span-2 flex items-center justify-center rounded-2xl border border-cine-border bg-cine-card p-8 text-cine-200">
                Em breve
              </div>
            )}
        ...
        {/* Right Sidebar */}
        <aside className="flex w-[292px] shrink-0 flex-col gap-2.5 rounded-[18px] border border-cine-border bg-cine-card-alt p-6 self-start">
